...
function toolbox_setup() {
	...
	/**
	* Agregamos soporte para las miniaturas
	*/
	add_theme_support( 'post-thumbnails' );
	add_image_size('plains-mini', 146, 9999, false);
	add_image_size('reportajes-principal', 600, 316, true);
	add_image_size('reportajes', 290, 158, false);
	add_image_size('plains-portada', 95, 144, false);
	add_image_size('opinion-portada', 295, 250, false);
	add_image_size('mini-lateral', 74, 74, false);
...
function toolbox_widgets_init() {
	...
	register_sidebar( array(
		'name' => 'Barra FEUC2013',
		'id' => 'sidebar-2',
		'description' => 'Barra lateral para la sección FEUC2013',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<p class="widget-title">',
		'after_title' => '</p>',
...
function toolbox_posted_on() {
	/*
	 <span class="sep"> por </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span>
	*/
	printf( __( /*'<span class="sep">Publicado el </span>*/'<a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"></span>', 'toolbox' ),
